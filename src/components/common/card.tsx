...
const Card: React.FC<Props> = () => {
	...
	// const { t } = useTranslation("common");
  	...
  	return (
		<Link
			href="#"
			className={`group flex justify-center items-center text-center rounded-lg px-4 lg:px-8 pt-7 lg:pt-10 pb-5 lg:pb-8 bg-gray-200" flex-col relative w-full`}
		>
			<div
			...
			>
				<div className="flex ">
					<img
						src="https://mcdn.coolmate.me/image/January2023/mceclip9_22.png"
				...
				<Text
					className='text-body text-sm sm:leading-6 leading-4 pb-0.5  md:text-[16px] text-[14px] text-center'
				>
					Trang sức vàng
				</Text>
